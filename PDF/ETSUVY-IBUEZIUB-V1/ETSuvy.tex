...
\begin{itemize}%
\item%
\textbf{ Une fois que tous les joueurs ont donné leur Indice, débattez entre vous pour déterminer qui peut être le Journaliste ou un Infiltré.}%
\item%
\textbf{ Votez tous en même temps en pointant de votre doigt la personne que vous soupçonnez.}%
\item%
\textbf{ Le joueur désigné par la majorité des votants est éliminé :}%
\end{itemize}%
\begin{enumerate}%
\item%
...
\begin{itemize}%
\item%
\textbf{ Débutez un nouveau tour en commençant par le joueur à gauche du joueur éliminé.}%
\item%
\textbf{ Enchaînez ainsi les tours jusqu’à ce que tous les Infiltrés et le Journaliste aient été éliminés ou qu’il ne reste plus que 2 joueurs :}%
\end{itemize}%
\begin{enumerate}%
\item%
...
\begin{itemize}%
\item%
\textbf{ Entamez une nouvelle Mission.}%
\end{itemize}
