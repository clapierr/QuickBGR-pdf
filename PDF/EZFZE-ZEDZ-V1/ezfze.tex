...
\begin{itemize}%
\item%
{[}NoEscape(\textbackslash{}textbf\{test\}), ' Une fois que tous les joueurs ont donné leur Indice, débattez entre vous pour déterminer qui peut être le Journaliste ou un Infiltré.\textbackslash{}r'{]}%
\item%
{[}NoEscape(\textbackslash{}textbf\{test\}), ' Votez tous en même temps en pointant de votre doigt la personne que vous soupçonnez.\textbackslash{}r'{]}%
\item%
{[}NoEscape(\textbackslash{}textbf\{test\}), ' Le joueur désigné par la majorité des votants est éliminé :\textbackslash{}r'{]}%
\end{itemize}%
\begin{enumerate}%
\item%
...
\begin{itemize}%
\item%
{[}NoEscape(\textbackslash{}textbf\{test\}), ' Débutez un nouveau tour en commençant par le joueur à gauche du joueur éliminé.\textbackslash{}r'{]}%
\item%
{[}NoEscape(\textbackslash{}textbf\{test\}), ' Enchaînez ainsi les tours jusqu’à ce que tous les Infiltrés et le Journaliste aient été éliminés ou qu’il ne reste plus que 2 joueurs :\textbackslash{}r'{]}%
\end{itemize}%
\begin{enumerate}%
\item%
...
\begin{itemize}%
\item%
{[}NoEscape(\textbackslash{}textbf\{test\}), ' Entamez une nouvelle Mission.\textbackslash{}r'{]}%
\end{itemize}
