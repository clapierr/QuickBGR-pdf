...
\textit{Vous}%
\textit{ }%
 avez 3 âges pour développer une grande cité du monde antique et construire une des 7 merveilles du%
...
\textit{ }%
\textit{DÉFAUSSER LA CARTE POUR OBTENIR 3 PIÈCES D’OR.}%
\textit{}
...
\textit{ Résolvez les conflits Militaires : Comparez le nombre de }%
\textit{Boucliers}%
\textit{ dans votre Cité avec celui de vos voisins de droite et de gauche.}%
\begin{itemize}%
\item%
%
