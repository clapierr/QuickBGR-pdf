...
\begin{itemize}%
\item%
\textbackslash{}textbf\{ Une fois que tous les joueurs ont donné leur Indice, débattez entre vous pour déterminer qui peut être le Journaliste ou un Infiltré.\} hey%
\item%
\textbackslash{}textbf\{ Votez tous en même temps en pointant de votre doigt la personne que vous soupçonnez.\} hey%
\item%
\textbackslash{}textbf\{ Le joueur désigné par la majorité des votants est éliminé :\} hey%
\end{itemize}%
\begin{enumerate}%
\item%
...
\begin{itemize}%
\item%
\textbackslash{}textbf\{ Débutez un nouveau tour en commençant par le joueur à gauche du joueur éliminé.\} hey%
\item%
\textbackslash{}textbf\{ Enchaînez ainsi les tours jusqu’à ce que tous les Infiltrés et le Journaliste aient été éliminés ou qu’il ne reste plus que 2 joueurs :\} hey%
\end{itemize}%
\begin{enumerate}%
\item%
...
\begin{itemize}%
\item%
\textbackslash{}textbf\{ Entamez une nouvelle Mission.\} hey%
\end{itemize}
