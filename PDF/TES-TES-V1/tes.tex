...
\item%
%
 L'échangercontre l'une de vos 12 cartes (visible ou cachée).%
\item%
%
...
\end{description}%
\textit{ Si le total de points est positif, vous devez le rajouter à votre total de points des manches }%
précédentes%
\textit{.}%
\begin{itemize}%
\item%
